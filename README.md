...
※このサービスは無料サーバーを使っているため、一定時間使われないとサーバーがスリープ状態になります。  
そのためリンクをクリックした後に、しばらく（約30秒）待ってからページを更新すると、アプリが正常に動作しログインできるようになります。
...
## 〇システムフローチャート　（ホーム画面）
フロントエンド：青赤　バックエンド：黄色　データベース：赤色  
![HomeDashboard js画面遷移 (1)](https://github.com/user-attachments/assets/2ba85155-15a7-4a3b-a7b3-85b77d83d72f)
